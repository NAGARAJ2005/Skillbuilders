...
public class AddToCart extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (success) {
                responseMessage = "{\"status\": \"success\", \"message\": \"Item added to cart successfully!\"}";
            } else {
                responseMessage = "{\"status\": \"error\", \"message\": \"Item already exists in your cart.\"}";
            ...
            e.printStackTrace();
            //xresponse.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
